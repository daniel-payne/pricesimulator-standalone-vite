...
export default function InactiveTradesPage({ name = "InactiveTradesPage", ...rest }: PropsWithChildren<ComponentProps>) {
  const [showJson, setShowJson] = useQueryState<boolean>("showJson", false)

  const trades = useInactiveTrades()
    ...
    <div {...rest} data-component={name}>
      <div className="flex flex-col gap-2 p-3">
        <div className="flex flex-row flex-wrap gap-2 items-center">
          ...
          <div className="text-secondary text-2xl font-bold">Inactive Trades</div>
