...
import UseCurrentMargins from "@/data/indexDB/hooks/UseCurrentMargins"
...
export default function CurrentMarginsPage({ name = "CurrentMarginsPage", ...rest }: PropsWithChildren<ComponentProps>) {
  const [showJson, setShowJson] = useQueryState<boolean>("showJson", false)

  const margins = UseCurrentMargins()
    ...
    <div {...rest} data-component={name}>
      <div className="flex flex-col gap-2 p-3">
        <div className="flex flex-row flex-wrap gap-2 items-center">
          ...
          <div className="text-secondary text-2xl font-bold">Margins</div>
