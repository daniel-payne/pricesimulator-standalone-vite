...
type ComponentProps = {
  marketData: Array<number | null | undefined> | null | undefined
...
export default function DataSparklineDisplay({ marketData, price, range = "1m", name = "DataSparklineDisplay", ...rest }: PropsWithChildren<ComponentProps>) {
  ...
  const data = price == null ? marketData : marketData?.slice(0, endDataIndex + 1) ?? []
